...
export default function MoreMenu({ onNavigate, onClose, onLogout, onHome, onFeedback, user, onShowTutorial, onDiagnose }) {
        ...
        >
          ...
          {onDiagnose && (
            ...
            >
              ...
              <div className="col gap-2" style={{ flex: 1, textAlign: 'left' }}>
                <span style={{ fontWeight: 600, fontSize: 14 }}>Diagnosticar conexión</span>
                <span className="tiny">Ver si Plaid tiene tus transacciones</span>
              </div>
          ...
          {onShowTutorial && (
            ...
            >
              ...
              <div className="col gap-2" style={{ flex: 1, textAlign: 'left' }}>
                <span style={{ fontWeight: 600, fontSize: 14 }}>Ver tutorial otra vez</span>
                <span className="tiny">Recorrido de 16 pasos por toda la app</span>
              </div>
              <Icon name="back" size={14} color="var(--text-mute)" stroke={2.5} style={{ transform: 'rotate(180deg)' }} />
            </button>
          )}
